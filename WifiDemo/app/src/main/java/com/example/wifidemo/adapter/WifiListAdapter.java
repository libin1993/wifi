package com.example.wifidemo.adapter;
...
public class WifiListAdapter extends RecyclerView.Adapter<WifiListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.tvWifiLevel.setText(bean.getLevel()+"");
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        View itemview;
        TextView tvItemWifiName, tvItemWifiStatus,tvWifiLevel;
        ...
        public MyViewHolder(View itemView) {
            ...
            tvWifiLevel = itemView.findViewById(R.id.tv_item_wifi_level);
        }
